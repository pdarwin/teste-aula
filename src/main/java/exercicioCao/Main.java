...
public class Main {
    ...
    { 
		...
		for (Animal animal :animais) 
			{
				System.out.println("Olá! " + animal.comunicar() +
						" Eu sou o " + animal.getNome() + 
						", tenho " + animal.getIdade() + " anos, " 
						+ animal.getPeso() + " quilos, e sou um" + 
						returnEsp(animal) + "!"); //" quilos, e sou um " + animal.getRaca() + "!");
			}
